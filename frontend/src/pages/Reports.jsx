...
import { fetchReports, updateStatus, downloadExport, deleteReport, getReportHistory, getLikes } from "../services/api";
    ...
    <div className="fade-in">
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 28 }}>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          {/* ✅ CORRIGÉ : utilise downloadExport avec onClick au lieu de <a href> */}
          <button
            onClick={() => downloadExport("excel", status)}
            className="btn btn-outline"
            style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 13, color: "var(--success)", borderColor: "var(--success)" }}
          >
            <Icons.Excel /> Exporter Excel
          </button>
          <button
            onClick={() => downloadExport("pdf", status)}
            className="btn btn-outline"

...
class AuthControllerIntegrationTest {
    ...
    void login_withValidCredentials_shouldReturn200AndToken() throws Exception, ExecutionException {
        ...
        MvcResult result = mockMvc.perform(post("/api/auth/login")
                ...
                .andReturn();
        String token = (String) objectMapper.readValue(result.getResponse().getContentAsString(), Map.class).get("token");
        assertNotNull(token);
    ...
    void login_withSecondAdmin_shouldReturn200AndToken() throws Exception, ExecutionException {
    ...
    void login_withUnknownEmail_shouldReturn401() throws Exception, ExecutionException {
    ...
    void login_withWrongPassword_shouldReturn401() throws Exception, ExecutionException {
    ...
    void login_withEmptyBody_shouldNotReturn200() throws Exception, ExecutionException {
        mockMvc.perform(post("/api/auth/login")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{}"))
    ...
    void protectedRoute_withoutToken_shouldReturn401() throws Exception, ExecutionException {
    ...
    void dashboard_withoutToken_shouldReturn401() throws Exception, ExecutionException {
    ...
    void dashboard_withValidToken_shouldNotReturn401() throws Exception, ExecutionException {
        Map<String, String> body = Map.of("email", "admin@roadwatch.com", "password", "admin123");
